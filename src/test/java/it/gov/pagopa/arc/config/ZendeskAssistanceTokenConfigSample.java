...
public class ZendeskAssistanceTokenConfigSample {
    ...
    public ZendeskAssistanceTokenConfig getCorrectConfiguration(){
        return new ZendeskAssistanceTokenConfig("JWT","help-center-url.com","zendesk-action-url.com", new ZendeskAssistanceTokenConfig.AssistanceToken("prod-arc", "_hc_arc", PRIVATE_KEY));
    }
}
