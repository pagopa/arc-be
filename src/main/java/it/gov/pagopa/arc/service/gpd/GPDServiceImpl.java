...
public class GPDServiceImpl implements GPDService{
    ...
    @Override
    public PaymentNoticeResponseDTO generatePaymentNoticeFromGPD(IamUserInfoDTO iamUserInfoDTO, PaymentNoticePayloadDTO paymentNoticePayloadDTO) {
