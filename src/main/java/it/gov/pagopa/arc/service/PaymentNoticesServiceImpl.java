...
public class PaymentNoticesServiceImpl implements PaymentNoticesService{
    ...
    @Override
    public PaymentNoticeResponseDTO retrieveGeneratedNotice(IamUserInfoDTO iamUserInfoDTO, PaymentNoticePayloadDTO paymentNoticePayloadDTO) {
        log.info("[POST_GENERATE_PAYMENT_NOTICE] User ID {} filled out a form to create a spontaneous payment, a payment notice was generated by GPD for EC {} with tax code {}", iamUserInfoDTO.getUserId(), paymentNoticePayloadDTO.getPaFullName(), paymentNoticePayloadDTO.getPaTaxCode());
        return gpdService.generatePaymentNoticeFromGPD(iamUserInfoDTO, paymentNoticePayloadDTO);
    }
}
